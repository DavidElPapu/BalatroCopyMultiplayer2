...
public class BalatroNetworkManager : NetworkManager
{
    private float currentPlayers;
    private List<MainPlayerScript> playerScripts;

    // Overrides the base singleton so we don't
    // have to cast to this type everywhere.
    public static new BalatroNetworkManager singleton => (BalatroNetworkManager)NetworkManager.singleton;
    ...
    public override void OnServerAddPlayer(NetworkConnectionToClient conn)
    {
        ...
        //if (conn.identity.TryGetComponent(out MainPlayerScript newPlayerScript))
        //{
        //    playerScripts.Add(newPlayerScript);
        //}
        //else
        //{
        //    Debug.Log("no se pudo conseguir el jugador");
        //}
    }
